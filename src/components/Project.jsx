  ...
  return (
    ...
    >
      ...
      <p className="text-gray-500 max-w-80 text-center mb-8 mx-auto">
        Creafting Spaces, Building Legacies-Explore Our Portfolio
      </p>
      ...
      <div className="flex justify-end items-center mb-8">
        ...
        <button onClick={nextProject} className="p-3 bg-gray-200 rounded mr-2">
          <img src={assets.right_arrow} alt="Next" aria-label="Next Projects" />
        </button>
      </div>
          ...
          {projectsData.map((project, index) => (
            ...
            >
              ...
              <div className=" absolute left-0 right-0 bottom-0 flex justify-center">
                <div className="inline-block bg-white w-3/4 py-2 px-4 shadow-md">
