  ...
  return (
    ...
    >
      <div className=" container mx-auto flex flex-col md:flex-row justify-between items-center">
        <div className=" w-full md:w-1/3 mb-8 md:mb-0">
          ...
          <p className=" text-gray-400 mt-4">
            ...
            saepe ipsum, laudantium sed pariatur reiciendis asperiores autem
            facilis minima.
          </p>
        </div>
        ...
        <div className=" w-full md:w-1/3">
          ...
          <div className="flex gap-2">
            <input
              ...
              className=" p-2 rounded bg-gray-800 to-gray-400 border border-gray-700 focus:outline-none w-full md:w-auto"
            />
      ...
      <div className=" border-t border-gray-700 py-4 mt-10 text-center text-gray-50">
        Copyright 2024 &#169; HighTech. All Rights Reserved.
      </div>
    </div>
  );
};
